...
public class MainViewController: UIViewController, UITextViewDelegate {
    ...
    public override func viewDidLoad() {
        ...
        setupNotifications()
        loadSavedScripts()
        // Start hidden – will be shown by forceShow() from Objective-C
        view.isHidden = true
    }

    @objc public func forceShow() {
    ...
    private func setupNotifications() {
        ...
        NotificationCenter.default.addObserver(
            self, selector: #selector(handleShowOverlay),
            name: NSNotification.Name("XZXShowOverlay"), object: nil)
    }
    ...
    @objc func close() {
        NotificationCenter.default.post(name: NSNotification.Name("XZXHideOverlay"), object: nil)
    }
